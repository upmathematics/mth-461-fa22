...
### Materials
  ...
  * `sampling-from-urns.R` - This R script provides R script for you to exhibit your theoretical and experimental results on a plot and to demonstrate how to sample with and without replacement works in R.
...
You have an urn with a total of 20 balls: 9 black balls and 11 red balls. You will draw 7 balls from this urn without replacement. Estimate the probability of drawing 0, 1, 2, 3, 4, 5, or 6 black balls and compare this estimate to the true probabilities.

1. Shown below is an example R code block. Run it and provide your initial output of the R script. Describe what the output shows you. Note that the initial simulation does not match the given scenario.
...
3. Modify the R script you were given to simulate the given scenario. When you modify the script, make sure you create a new file with a new file name and run it similarly from problem 1. Prove an output below and describe your observations.
