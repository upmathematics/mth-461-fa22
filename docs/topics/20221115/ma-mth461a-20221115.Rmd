...
3. True or False? If $X \sim Exponential(\lambda_x)$ and $Y \sim Exponential(\lambda_y)$ then $X + Y \sim Exponential(\lambda_x + \lambda_y)$. Justify your answer. (Hint: Check first if X and Y are independent, find the joint MGF, then match results to known MGFs.)
