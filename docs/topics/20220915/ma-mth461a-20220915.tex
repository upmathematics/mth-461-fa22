...
\hypersetup{
  pdftitle={Random Variables \& Probability Functions},
  colorlinks=true,
  linkcolor={Maroon},
  filecolor={Maroon},
  citecolor={Blue},
...
\item
  ...
  \end{enumerate}
\item
  Consider an experiment where observing a six is a success (not observing a six is a failure). Suppose that the number of rolls is 3. Apply the Binomial Probability Mass Function to answer the following questions.
