...
\title{\textbf{Probability Theory Basics Part 2}}
\usepackage{etoolbox}
\makeatletter
...
\item
  ...
  \def\labelenumii{\alph{enumii}.}
  \item
    How many possible outcomes are there? You don't have to make table.
  \item
    What is the probability that the first roll has a sum of 6 and the second roll has a sum of 4?
  \item
    What is the probability of rolling a total sum is 13?
  \item
