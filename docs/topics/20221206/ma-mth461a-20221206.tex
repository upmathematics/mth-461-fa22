...
\title{\textbf{Maximum Likelihood Estimation}}
\usepackage{etoolbox}
\makeatletter
...
\item
  Suppose \(X_i \sim Exponential(\theta)\) and we have observed \((x_1,x_2,x_3,x_4) = (1.23,3.32,1.98,2.12)\).
...
\item
  Suppose \(X_i \sim Poisson(\theta)\) and we have observed \((x_1,x_2,x_3,x_4) = (2,3,3,5)\)
